                        ...
                        <React.Fragment>
                                <Slide right>
                                        ...
                                        <div className="new-task">
                                                ...
                                                <form className={ "new-task__body needs-validation " + (this.state.formError ? "was-validated" : "") }   noValidate onSubmit={this.handleCreate}>
                                                        <div className="md-form new-task_input mt-5">
                                                                <textarea id="new-task-text" className="md-textarea form-control" rows="3" value={ this.state.taskTitle } onChange={this.handleChange} required></textarea>
                                                                <label htmlFor="new-task-text">What are you planning?</label>
                                                                <Fade><div className="invalid-feedback">Think of something you need to do <span role="img" aria-label="tongue">🤪</span>...</div></Fade>
                                                        </div>
                                                        ...
                                                        <div className="new-task_button">
                                                                <button type="submit" className="btn btn-block btn-danger btn-sm pt-2 pb-2">Create</button>
                                                        </div>
                                                </form>
                                        </div>
                                </Slide>
